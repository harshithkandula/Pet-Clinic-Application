    ...
    <body>
        <div style="color: coral;">
            ...
            <ul>
                <li class="ddn">
                    <button>
                        <a href="http://54.80.25.204:9090/">Home</a>
                    </button>
                </li>
                <li class="ddn">
                    <button>
                ...
                <li class="ddn">
                    ...
                    <div class="ddn-ctn">
                        <a href="http://54.80.25.204:9090/book-appoint">Book Appointment</a>
                    </div>
                    <div class="ddn-ctn">
                        <a href="http://54.80.25.204:9090/list">List of Pets</a>
                    </div>
                     <div class="ddn-ctn">
                        <a href="http://54.80.25.204:9090/list-appoints">List of Appointments</a>
                    </div>
                </li>
                <li class="ddn">
                    <button>
                    ...
                    <div class="ddn-ctn">
                        <a href="http://54.80.25.204:9090/list-appoints"> Give Treatment</a>
                    </div>
                </li>
